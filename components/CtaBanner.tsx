    ...
    <section className="py-8 sm:py-12 md:py-16">
      <div className="px-6 sm:px-8 md:px-14">
        <div className="mx-auto max-w-6xl">
          <div className="relative isolate flex flex-col items-center justify-between gap-8 overflow-hidden rounded-2xl sm:rounded-[32px] border border-terracotta/15 bg-forest p-8 shadow-[0_12px_40px_rgba(10,42,107,0.18)] md:flex-row md:gap-12 md:px-12 md:py-16">
            <div
              aria-hidden="true"
